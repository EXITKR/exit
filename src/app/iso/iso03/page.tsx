            ...
            <div className="content_box_content title gc-1-4">
              <span className="content_text">
                <span className="tx-24">
                  ISO 45001은 국제표준화기구(ISO)가 제정한 세계 최초의 국제 산업안전보건 경영시스템(OH&S)으로 사업장에서<br/>발생할 수 있는 각종 위험을 사전 예측 및 예방하고, 작업자 안전을 위한 실용적인 솔루션을 제공하는<br/>산업 보건 및 안전 관리 경영시스템의 국제 표준입니다.
                </span>
              </span>
            </div>
