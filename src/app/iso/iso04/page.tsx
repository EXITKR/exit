          ...
          <div className="content_box">
            ...
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                ...
                <span className=" ">해당 제품이 유럽 기준에 부합하는 높은 수준의 안전성과 적합성을 확보</span>하고 있음을 의미합니다.
              </span>
            </div>
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                CE 인증을 통해 귀사의 제품은&nbsp;
                <span className="">EU 연합내의 수출에 제한이 없어 유럽 시장 진출의 기반을 마련하고, 글로벌 경쟁력 또한 강화</span>할 수 있습니다.
              </span>
            </div>
          </div>
        </>
          ...
          <div className="content_box">
            ...
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                ...
                <span className=" ">제품의 신뢰성</span>을 입증할 수 있습니다.
              </span>
            </div>
          </div>
        </>
