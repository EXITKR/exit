      ...
      case 0:
        return <>
          <div className="content_box">
            ...
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                <span className=" ">‘유통사 - 납품업체 - 3PL 업체’</span>의 흐름으로 이어지는 전방위적인&nbsp;
                <span className="">개인정보보호 시스템 구축</span>은 개인정보보호법 위반에 대한&nbsp;
                <span className=" ">기업의 법적 리스크를 최소화</span>하고 안전하게 개인정보를 활용하기 위한 시스템 구축을 적극적으로 도입하고 있습니다.
              </span>
            </div>
          </div>
        </>
        ...
        return <>
          <div className="content_box">
            <div className="content_box_content title gc-1-4">
              <span className="content_text">
                <span className=" ">
                  정보유출방지(DLP)는 조직 내 중요 정보와 데이터를 보호하기 위해,
                  <br />
                  문서·이미지 등 저장된 파일 내 주요 정보를 탐지하고 저장매체, 출력, 파일 전송 등
                  <br />
                  다양한 경로를 통해 발생할 수 있는 유출을 차단함으로써 외부 유출을 예방하는 시스템입니다.
                </span>
              </span>
            </div>
            <div className="content_img gc-1-4">
            ...
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                ...
                <span className="">설치와 관리가 용이하고, 사내 네트워크를 통한 데이터 전송을 집중적으로 감시</span>할 수 있어 기업들이 필수적으로 도입하고 있습니다.
              </span>
            </div>
          </div>
        </>
        ...
        return <>
          <div className="content_box">
            <div className="content_box_content title gc-1-4">
              <span className="content_text">
                <span className=" ">
                  ISO 27001은 규모와 활동분야에 관계없이 모든 기업에 정보보안관리시스템을 구축, 구현, 유지 및 지속적으로 개선하기 위한 국제표준입니다.
                </span>
              </span>
            </div>
            <div className="content_img gc-1-4">
