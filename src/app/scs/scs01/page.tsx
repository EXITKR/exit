          ...
          <div className="content_box">
            <div className="content_box_content title gc-1-4">
              <span className="content_text">
                <span className="tx-24">공급망 보안은 기업의 공급망을 보호하고, 외부 위협으로부터 안정성을 유지하는 데 초점을 맞춘 개념입니다.</span>
              </span>
            </div>
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                공급망 보안은 하청, 외주, 부자재 등 공급망 전반에 걸친 윤리적조달 체계는 물론, 환경 관리 수준, 내부 통제 시스템의 문서화, 불만처리 절차 등까지 포괄하여 지속적인 개선 여부를 실사와 모니터링을 통해 확인하는 체계로 운영됩니다. 고객맞춤형 공급망 보안은 고객의 요구도에 맞추어 물리적 보안, 사이버 보안, 운영 리스크 관리, 규제준수 등을 포함하여 공급망의 전반적인 안정성을 확보하는 것을 지원합니다.
              </span>
            </div>
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
