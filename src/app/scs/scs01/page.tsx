          ...
          <div className="content_box">
            ...
            <div className="content_box_content gc-1-2 sect_point">
              <span className="content_text">
                ...
                <span className="fw-500">환경 관리 수준, 내부 통제 시스템의 문서화, 불만처리 절차</span> 등까지 포괄하여 지속적인 개선 여부를 실사와 모니터링을 통해 확인하는 체계로 운영됩니다.
                <br />
                <span className="fw-500 tc-gr">고객맞춤형 공급망 보안</span>은 고객의 요구도에 맞추어&nbsp;
