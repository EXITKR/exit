          ...
          <div className="content_box">
            <div className="content_box_content title gc-1-4">
              <span className="content_text">
                <span className=" ">COC는 조직이나 기업이 구성원들에게 기대하는 행동 기준을 명확히 정의하는 규범입니다.</span>
              </span>
            </div>
            ...
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                ...
                <span className="">전체 공급망의 윤리성과 지속 가능성을 체계적으로 관리하는 방향으로 진화</span>하고 있습니다.
              </span>
            </div>
            <div className="content_box_content gc-1-4 sect_point">
              <span className="content_text">
                COC는 조직이&nbsp;
                <span className=" ">투명하고 공정한 방식</span>으로 운영되도록 보장하며, 규범을 준수함으로써&nbsp;
                <span className=" ">법적 리스크를 감소</span>시키고, 구성원들이 공통된 가치와 행동 기준을 공유하여&nbsp;
                <span className=" ">긍정적인 조직문화를 형성</span>하며, 윤리적 문제나 내부 갈등 발생 시 명확한 기준을 제공하여 효과적으로 대응할 수 있습니다.
              </span>
            </div>
          </div>
        </div>
