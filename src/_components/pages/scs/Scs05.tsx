            ...
            <div className="content_box_content title gc-1-4">
              <span className="content_text">
                <span className="tx-24">
                  미국 세관에서 실시하는 C-TPAT (Customs Trade Partnership Against Terrorism) 프로그램은 알 카에다에 의한<br/>9.11 테러 후에 발효된 미국 세관당국과 미국 내 수입 관련 기업 간의 테러방지 협약이며, 2024년 기준 1만 개 이상의 업체가<br/>이 협약에 가입하고 있습니다.
                </span>
              </span>
            </div>
        ...
        return <>
          <div className="content_box">
            <div className="content_box_content title gc-1-4">
              <span className="content_text">
                <span className="tx-24">
                  AEO인증 기업은 통관 절차에서 우선 처리되어 지연시간을 최소화하고, 빠른 배송을 통해 물류 비용을 절감할 수 있으며,<br/>세금 유예와 통관 절차 간소화 등의 세금 혜택을 받을 수 있습니다.
                </span>
              </span>
            </div>
            <div className="content_img gc-1-4">
